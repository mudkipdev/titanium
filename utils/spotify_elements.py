...
async def song(
    ...
    embed = discord.Embed(
        ...
        description=f"on **[{discord.utils.escape_markdown(item['album']['name'])}](<{item['album']['external_urls']['spotify']}>) • {item['album']['release_date'].split('-', 1)[0]}**",
    ...
    class SpotifyButtonsMenu(View):
        ...
        async def art(
            ...
            if item["album"]["images"] != None:
                ...
                if (
                    item["album"]["images"][0]["height"] == None
                    or item["album"]["images"][0]["width"] == None
                ):
                    embed = discord.Embed(
    ...
    class SpotifyButtonsMenu(View):
        ...
        async def art(
            ...
            if item["images"] != None:
                ...
                if (
                    item["images"][0]["height"] == None
                    or item["images"][0]["width"] == None
                ):
                    embed = discord.Embed(
                        title=f"{item['name']} ({artist_string}) - Album Art",
                        description="Viewing highest quality (Resolution unknown)",
